...
<div style="padding:30px 10px; max-width: 600px; margin: auto;">
  ...
  <form method="POST" action="request.php">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputChannelId" name="channelId" placeholder="Enter X-LINE-ChannelId" value="<?=isset($config['channelId']) ? $config['channelId'] : '1657830205'?>" required>
    </div>
    <div class="form-group">
      <label for="inputChannelSecret">ChannelSecret</label>
      <input type="text" class="form-control" id="inputChannelSecret" name="channelSecret" placeholder="Enter X-LINE-ChannelSecret" value="<?=isset($config['channelSecret']) ? $config['channelSecret'] : '1bb904cdddf58244de0f2809a8999c72'?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputAmount" name="amount" placeholder="Your product amount" value="<?=isset($config['amount']) ? $config['amount'] : '250'?>" required value="20">
    </div>
    <div class="form-group">
